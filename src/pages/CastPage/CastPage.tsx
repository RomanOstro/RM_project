...
import {
  CardTitle, CastDetailsContainer, CastImageWrapper, CastName, ImageBlock, ImageCast,
  ImageCastLayout, ImageWrapper, PageContainer, PageContent, Separator, StatusBarBlock,
  StatusCard, CardIcon, CardInfo, StatusCardLayout, CardSubtitle,
  CardDetails,
  CardDetailsLayout,
  EpisodesContainer,
      ...
      <PageContent>
        ...
        <CastImageWrapper>
          ...
          <ImageBlock>
            <ImageCastLayout />
            <ImageWrapper>
              <ImageCast src={dataCharacterSingle?.image} alt={`picture ${dataCharacterSingle?.name}`} />
            </ImageWrapper>
          </ImageBlock>
            ...
            <EpisodesInfo>
              ...
              <EpisodeList>
                {episodesData?.map(episode => {
                  return <EpisodeListItem key={episode.id}>{episode.name}</EpisodeListItem>
                })}
